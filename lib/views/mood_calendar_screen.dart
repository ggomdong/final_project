...
import 'package:final_project/views/widgets/calendar.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<MoodModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (_isFirstLoading) {
            final todayMillis = DateTime(_selectedDay.value.year,
                  ...
                  builder: (context, selectedDay, _) {
                    return TableCalendar(
                      ...
                      onPageChanged: (newFocusedDay) {
                        ...
                        final newFirstDay = DateTime(newFocusedDay.year,
                            newFocusedDay.month, 1); // 변경된 월의 정확한 1일
